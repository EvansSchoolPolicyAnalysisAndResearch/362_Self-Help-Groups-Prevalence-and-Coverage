...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  Uganda Financial Inclusion Insights (FII) survey Wave 4 (2016) 											
...
*over the period July - August 2016.
...
*-----------
*This master do file constructs selected indicators using the Uganda FII data set.
...
global UG_FIIW4_data 							"FII/Raw Data"
...
*CLEAN DATA
************
use "$UG_FIIW4_data\FII 2016 Uganda Wave 4 Data.dta", clear
...
*Mobile Money
ren MM2_1 aware_MTN
ren MM2_2 aware_airtel_money
ren MM2_3 aware_msente
ren MM2_4 aware_ezee
ren MM2_5 aware_africell
ren MM2_6 aware_safaricom
ren MM2_7 aware_other
ren MM4_1 use_MTN
ren MM4_2 use_airtel_money
ren MM4_3 use_msente
ren MM4_4 use_ezee
ren MM4_5 use_africell
ren MM4_6 use_safaricom
ren MM4_7 use_other
*Official ID
ren DG5_1 id_gov
...
ren IFI1_1 use_MFI
ren IFI1_2 use_coop
ren IFI1_3 use_SACCO	//Savings and Credit Cooperative
...
replace MM_use = 0 if aware_MTN!=. | aware_airtel_money!=. | aware_msente!=. | aware_ezee!=. | aware_africell!=. | aware_safaricom!=. | aware_other!=.
replace MM_use = 1 if use_MTN==1 | use_airtel_money==1 | use_msente==1 | use_ezee==1 | use_africell==1 | use_safaricom==1 | use_other !=.
//n=3,000
...
replace SACCO_fin_acct = 0 if fin_acct_SACCO==2 //IFI3_3 = SACCO account  
...
replace coop_fin_serv = 0 if fin_acct_coop==2 //IFI3_2 = cooperative acct 
replace coop_fin_serv = 1 if fin_acct_coop==1 
//n=3,000
...
replace SHG_membership = 0 if member_SHG==0 | member_SHG==99 //member_SHG - How many informal societies or group savings schemes do you personally belong to? 99=missing
...
replace SACCO_use_any = 0 if SACCO_use_self_report == 0 | SACCO_fin_serv == 0 
replace SACCO_use_any = 1 if SACCO_use_self_report == 1 | SACCO_fin_serv == 1 
//n=3,000
...
lab var SACCO_loan_current "Proportion of individuals who have a current loan with a SACCO (Among those who have ever borrowed from a SACCO)"
replace SACCO_loan_current = 0 if loan_current_SACCO != . //loan_current_SACCO = SACCO
...
replace ASCA_loan_current = 0 if loan_current_ASCA != . //loan_current_ASCA = ASCA
...
replace merry_loan_current = 0 if loan_current_merry != . //loan_current_merry = merry go round
...
lab var SACCO_int_rt_loan "Individual knows interest rate of their SACCO loan (Among individuals with a SACCO loan)"
...
lab var ASCA_int_rt_loan "Individual knows interest rate of their ASCA loan (Among individuals with a ASCA loan)"
...
lab var merry_int_rt_loan "Individual knows interest rate of their merry go round loan (Among individuals with a merry-go-round loan)"
...
lab var SACCO_int_rt_sav "Individual knows interest rate of their SACCO savings account (Among individuals that save with a SACCO)"
...
gen ASCA_int_rt_sav = . 
lab var ASCA_int_rt_sav "Individual knows interest rate of their ASCA/VSLA savings account (Among individuals that save with an ASCA/VSLA)"
...
lab var merry_int_rt_sav "Individual knows interest rate of their merry go round savings account (Among individuals that save with a merry-go-round)"
...
*Saving
save "$created_data\UG_FII_final.dta", replace

************
*Disaggregate and Export
************ 
use "$created_data\UG_FII_final.dta", clear
...
*/ SHG_use_emergency SHG_loan_current coop_loan_only SACCO_loan_only SHG_loan_only /*
*/ SACCO_mobile_serv coop_mobile_serv SHG_mobile_serv SHG_int_rt_any /*
...
global coverage_indicators SACCO_use_any coop_use_any merry_use_any SHG_use_any SACCO_advice merry_advice SHG_advice SACCO_fin_serv ASCA_fin_serv merry_fin_serv coop_fin_serv SHG_fin_serv SHG_membership
...
*Create global of users vs. non-user indicators
	*ASCAs, Cooperatives (unspecified), Merry-Go-Round, SACCO
...
*Coverage indicators
putexcel set "$final_data\UG_FII_estimates.xls", modify sheet("Coverage", replace)
...
putexcel set "$final_data\UG_FII_estimates.xls", modify sheet("Characteristics", replace)
...
putexcel set "$final_data\UG_FII_estimates.xls", modify sheet("Users vs. Non-Users", replace)
...
putexcel set "$final_data\UG_FII_estimates.xls", modify sheet("Country Demographics", replace)
